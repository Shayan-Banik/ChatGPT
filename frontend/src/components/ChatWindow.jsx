      ...
      {isTyping && (
        <div className="flex gap-4 justify-start">
          <div className="flex gap-3 max-w-[85%] sm:max-w-[75%] lg:max-w-[65%]">
            <div className="w-8 h-8 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center flex-shrink-0">🤖</div>
            <div className={`p-4 rounded-2xl rounded-tl-sm ${darkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
